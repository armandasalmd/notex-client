                ...
                children: {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            children: (
                                <span>
                                    <p>You don't need to pay for this app. It's completely free</p>
                                </span>
                            )
                        }
                    ]
        ...
        children: [
            {
                ...
                content: {
                    ...
                    children: (
                        <span>
                            <p>You can create separate notebooks acting as folders to group your work together</p>
                        </span>
                    )
                }
            },
            {
                ...
                content: {
                    ...
                    children: (
                        <span>
                            <p>Make your notes public or private. When choosing public, you can share the link with your friends&nbsp;</p>
                        </span>
                    )
                }
            },
            {
                ...
                content: {
                    ...
                    children: (
                        <span>
                            <p>
                                Focus on editing rather than formatting the document. Easy to use editor will let you to create your notes real quick
                            </p>
                        </span>
                    )
                }
        ...
        children: [
            {
                ...
                button: { className: "banner2-button", children: <Link to="/auth/register">Create an account</Link> }
            }
        ]
    }
};
